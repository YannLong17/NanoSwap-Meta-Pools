...
creator_balances = get_account_balances(amm_client.indexer, creator_account.getAddress())
print("User Balances:")
print("UStest: %i, Nanopool asset 1: %i, Nanopool asset 2: %i" % 
...
creator_balances_2 = get_account_balances(amm_client.indexer, creator_account.getAddress())
print("Swapped %i UStest for Nanopool asset 2, Balance delta:" % x)
print("UStest: %i, Nanopool asset 1: %i, Nanopool asset 2: %i" % 
    (creator_balances_2[metapool.meta_asset_id] - creator_balances[metapool.meta_asset_id], 
    creator_balances_2[metapool.nanopool.asset1.asset_id]- creator_balances[metapool.nanopool.asset1.asset_id],
    creator_balances_2[metapool.nanopool.asset2.asset_id] - creator_balances[metapool.nanopool.asset2.asset_id]))
creator_balances = creator_balances_2
# Swap asset 2 for US test
metapool.metaswap(creator_account, metapool.nanopool.asset2.asset_id, x, metapool.meta_asset_id)
creator_balances_2 = get_account_balances(amm_client.indexer, creator_account.getAddress())
...
metapool.metaswap(creator_account, metapool.nanopool.asset1.asset_id, x, metapool.meta_asset_id)
creator_balances_2 = get_account_balances(amm_client.indexer, creator_account.getAddress())
